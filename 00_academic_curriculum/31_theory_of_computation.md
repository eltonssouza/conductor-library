...
This work presents the theory of computation through theorems and proofs, always with the author's concern to show the intuition behind each result and to ease the reading of the latter by presenting, for each theorem, an idea of the proof. With this book, through the practice of problem solving, students will, in the exercises, review definitions and concepts of the field and, in the problems, will encounter activities that require greater ingenuity. The last three chapters are new, and this 2nd edition incorporates the suggestions of teachers and students sent to the author over the years. It contains material for more than one semester of a course, providing flexibility to choose topics to be explored more or less deeply.
